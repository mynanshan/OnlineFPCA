...
setEPS()
postscript(file="text-onlineFPCA/figures/gfr_taupath.eps", width=9, height=5)
with(tau.select, plot.tau_path2(tau.history, tau.selectId))
dev.off()

setEPS()
postscript("text-onlineFPCA/figures/gfr_time.eps", width = 6, height=5)
