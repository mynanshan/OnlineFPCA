...
#SBATCH --job-name=check_nbatch_1d
#SBATCH --output=logs/nbatch1d_%j.out
#SBATCH --time=3:00:00
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
res <-
  foreach(nBatch = nBatchList, .combine = "rbind") %dofuture% {

    cat("Settings: ", "nBatch =", nBatch, "\n")
